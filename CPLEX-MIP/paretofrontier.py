# -*- coding: utf-8 -*-
"""
Created on Wed Jul  9 12:45:57 2025
...
ax = test.sort_values(by=['NumBuses[#]']).plot(x='NumBuses[#]', y='IdleTime(Gap)[sec]', xlabel="numBuses", ylabel="IdleTime(Gap)[sec]", legend=False, title=f"20Trips1CS_ParetoFrontier")
fig = ax.get_figure()
...
ax = test.sort_values(by=['NumBuses[#]']).plot(x='NumBuses[#]', y='IdleTime(Gap)[sec]', xlabel="numBuses", ylabel="IdleTime(Gap)[sec]", legend=False, title=f"20Trips3CS_ParetoFrontier")
fig = ax.get_figure()
...
ax = test.sort_values(by=['NumBuses[#]']).plot(x='NumBuses[#]', y='IdleTime(Gap)[sec]', xlabel="numBuses", ylabel="IdleTime(Gap)[sec]", legend=False, title=f"30Trips1CS_ParetoFrontier")
fig = ax.get_figure()
...
ax = test.sort_values(by=['NumBuses[#]']).plot(x='NumBuses[#]', y='IdleTime(Gap)[sec]', xlabel="numBuses", ylabel="IdleTime(Gap)[sec]", legend=False, title=f"30Trips3CS_ParetoFrontier")
fig = ax.get_figure()
...
ax = test.sort_values(by=['NumBuses[#]']).plot(x='NumBuses[#]', y='IdleTime(Gap)[sec]', xlabel="numBuses", ylabel="IdleTime(Gap)[sec]", legend=False, title=f"40Trips1CS_ParetoFrontier")
fig = ax.get_figure()
...
ax = test.sort_values(by=['NumBuses[#]']).plot(x='NumBuses[#]', y='IdleTime(Gap)[sec]', xlabel="numBuses", ylabel="IdleTime(Gap)[sec]", legend=False, title=f"40Trips3CS_ParetoFrontier")
fig = ax.get_figure()
...
ax = test.sort_values(by=['NumBuses[#]']).plot(x='NumBuses[#]', y='IdleTime(Gap)[sec]', xlabel="numBuses", ylabel="IdleTime(Gap)[sec]", legend=False, title=f"54Trips1CS_ParetoFrontier")
fig = ax.get_figure()
