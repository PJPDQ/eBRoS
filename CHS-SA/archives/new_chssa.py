# -*- coding: utf-8 -*-
"""
Created on Sun Aug 31 22:40:04 2025
...
max_it = 10
import numpy as np
from misc import visualizeResult, visualizeSolution, apply_custom_shift, get_total_gap
from improved_chs import ImprovedEVScheduler, flatten_link_names, vectorSchRepresentation, ScheduleState
from neighbourhood import ImprovedNeighborhoodGenerator, NeighborhoodStats, annealing
...
# schedules_tab, schedules_10_1 = scheduler.constructive_scheduler_improved(all_schs_1cs, arcs, recharge_1cs_arcs, cs_ids)
...
# new_schedule_10_1, cost_10_1, cost_diffs_10_1, temp_10_1, it_10_1, costs_10_1, solution_spaces_10_1, best_costs_10_1 = annealing(solution, all_schs_1cs, arcs, recharge_1cs_arcs, D_MAX=D_MAX)
...
# scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
# test_schedules_tab, schedules_10_3 = scheduler.constructive_scheduler_improved(all_schs_3cs, arcs, recharge_3cs_arcs, set(cs_ids))
...
# print("starting simulated annealing....")
# start_time = time.time()
# new_schedule_10_3, cost_10_3, cost_diffs_10_3, temp_10_3, it_10_3, costs_10_3, solutionspaces_10_3, best_10_3 = annealing(test_solution, all_schs_3cs, arcs, recharge_3cs_arcs, D_MAX=D_MAX)
# end_time = time.time()
...
if not debugging:
    ...
    scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
    schedules_tab, schedules_20_1 = scheduler.constructive_scheduler_improved(all_schs_1cs, arcs, recharge_1cs_arcs, cs_ids)
    ...
    start_time = time.time()
    print("starting simulated annealing....")
    new_schedule_20_1, cost_20_1, cost_diffs_20_1, temp_20_1, it_20_1, costs_20_1, solution_spaces_20_1, best_costs_20_1 = annealing(solution, all_schs_1cs, arcs, recharge_1cs_arcs, D_MAX=D_MAX)
    end_time = time.time()
    ...
    scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
    test_schedules_tab, schedules_20_3 = scheduler.constructive_scheduler_improved(all_schs_3cs, arcs, recharge_3cs_arcs, set(cs_ids))
    ...
    print("starting simulated annealing....")
    start_time = time.time()
    new_schedule_20_3, cost_20_3, cost_diffs_20_3, temp_20_3, it_20_3, costs_20_3, solutionspaces_20_3, best_20_3 = annealing(test_solution, all_schs_3cs, arcs, recharge_3cs_arcs, D_MAX=D_MAX)
    end_time = time.time()
    ...
    scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
    schedules_tab, schedules_30_1 = scheduler.constructive_scheduler_improved(all_schs_1cs, arcs, recharge_1cs_arcs, cs_ids)
    ...
    start_time = time.time()
    print("starting simulated annealing....")
    new_schedule_30_1, cost_30_1, cost_diffs_30_1, temp_30_1, it_30_1, costs_30_1, solution_spaces_30_1, best_costs_30_1 = annealing(solution, all_schs_1cs, arcs, recharge_1cs_arcs, D_MAX=D_MAX)
    end_time = time.time()
    ...
    scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
    test_schedules_tab, schedules_30_3 = scheduler.constructive_scheduler_improved(all_schs_3cs, arcs, recharge_3cs_arcs, set(cs_ids))
    ...
    print("starting simulated annealing....")
    start_time = time.time()
    new_schedule_30_3, cost_30_3, cost_diffs_30_3, temp_30_3, it_30_3, costs_30_3, solutionspaces_30_3, best_30_3 = annealing(test_solution, all_schs_3cs, arcs, recharge_3cs_arcs, D_MAX=D_MAX)
    end_time = time.time()
    ...
    # print(f"{time.ctime()}")
    # scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
    # schedules_tab, schedules_40_1 = scheduler.constructive_scheduler_improved(all_schs_1cs, arcs, recharge_1cs_arcs, cs_ids)
    ...
    # print(f"schedules_40 = {schedules_40_1}\n{len(schedules_40_1)}")
    # start_time = time.time()
    # print("starting simulated annealing....")
    # new_schedule_40_1, cost_40_1, cost_diffs_40_1, temp_40_1, it_40_1, costs_40_1, solution_spaces_40_1, best_costs_40_1 = annealing(solution, all_schs_1cs, arcs, recharge_1cs_arcs, D_MAX=D_MAX)
    # end_time = time.time()
    ...
    # print(f"{time.ctime()}")
    # scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
    # schedules_tab, schedules_40_3 = scheduler.constructive_scheduler_improved(all_schs_3cs, arcs, recharge_3cs_arcs, set(cs_ids))
    ...
    # print("starting simulated annealing....")
    # start_time = time.time()
    # new_schedule_40_3, cost_40_3, cost_diffs_40_3, temp_40_3, it_40_3, costs_40_3, solutionspaces_40_3, best_40_3 = annealing(test_solution, all_schs_3cs, arcs, recharge_3cs_arcs, D_MAX=D_MAX)
    # end_time = time.time()
    ...
    scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
    schedules_tab, schedules_54_1 = scheduler.constructive_scheduler_improved(all_schs_1cs, arcs, recharge_1cs_arcs, cs_ids)
    ...
    start_time = time.time()
    print("starting simulated annealing....")
    new_schedule_54_1, cost_54_1, cost_diffs_54_1, temp_54_1, it_54_1, costs_54_1, solution_spaces_54_1, best_costs_54_1 = annealing(solution, all_schs_1cs, arcs, recharge_1cs_arcs, D_MAX=D_MAX)
    end_time = time.time()
    ...
    scheduler = ImprovedEVScheduler(max_iterations=50, d_max=350)
    test_schedules_tab, schedules_54_3 = scheduler.constructive_scheduler_improved(all_schs_3cs, arcs, recharge_3cs_arcs, set(cs_ids))
    ...
    print("starting simulated annealing....")
    start_time = time.time()
    new_schedule_54_3, cost_54_3, cost_diffs_54_3, temp_54_3, it_54_3, costs_54_3, solutionspaces_54_3, best_54_3 = annealing(test_solution, all_schs_3cs, arcs, recharge_3cs_arcs, D_MAX=D_MAX)
    end_time = time.time()
